...
// Merge into the existing file rather than overwrite it outright, so
// branding fields (logo, etc.) survive `npm run serve` instead of getting
// wiped every time a local backend URL is injected.
